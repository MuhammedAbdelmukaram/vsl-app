            ...
            <div className={styles.content}>
                <div className={styles.features}>
                    <div className={styles.feature}>
                        <Image src="/d1.svg" alt="Partner 1" width={75} height={75} className={styles.logo}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d2.svg" alt="Partner 1" width={75} height={75} className={styles.logo}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d3.svg" alt="Partner 1" width={75} height={75} className={styles.logo}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d4.svg" alt="Partner 1" width={75} height={75} className={styles.logo}/>
                        <div>
