            ...
            <div className={styles.content}>
                <div className={styles.features}>
                    <div className={styles.feature}>
                        <Image src="/d1.svg" alt="Icon representing full video performance overview" width={55} height={55} className={styles.logo2}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d2.svg" alt="Icon representing video retention graph" width={55} height={55} className={styles.logo2}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d3.svg" alt="Icon representing audience segmentation" width={55} height={55} className={styles.logo2}/>
                        <div>
                    ...
                    <div className={styles.feature}>
                        <Image src="/d4.svg" alt="Icon representing video drop-off alerts" width={55} height={55} className={styles.logo2}/>
                        <div>
